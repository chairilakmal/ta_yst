                ...
                <div class="row card-deck ">                             
                    <div class="halaman-view mt-5 w-100">
                        ...
                        <div class="view-desc-singkat mt-2">
                            ...
                            <div class="d-flex view-kumpulan  mb-3">
                                <div class="float-left">Kegiatan akan dilaksanakan di <b><?php echo $result['lokasi_program']?></b></div>
                                <div class="ml-2">pada</div>
                                <div class="ml-2"><?php echo date("d-m-Y",strtotime($result['tgl_pelaksanaan']));?></div> 
                                    ...
                                    Sisa Waktu
                                        ...
                                        const hitungMundur = setInterval(function() {
                                            ...
                                            if(selisih < 0){
                                                ...
                                                data    : { status_program_relawan : status_program_relawan, id_program_relawan : id_program_relawan},
