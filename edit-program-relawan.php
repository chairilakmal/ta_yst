...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <main>
                ...
                <div class="mt-2 regis-title"><h3>Input Program Relawan</h3></div>    
                ...
                <input type="hidden" name="gambarLama" value="<?= $programRelawan['foto_p_relawan']; ?>">
                    <div class="form-group label-txt">
                        <div class="form-group mt-4 mb-3">
                            ...
                            <input type="text" id="tb_nama_program_relawan" name="tb_nama_program_relawan" 
                        ...
                        <div class="form-group mb-5 ">
                                    ...
                                    <div class="radio-wrapper mt-1">
                                        <div class="form-check form-check-inline">
                                            ...
                                            class="form-check-input" value="Pending" <?php if($programRelawan['status_program_relawan']=='Pending') echo 'checked'?>>
